...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_normal_item_normal(self):
        items = [Item("+5 Dexterity Vest", 10, 20), Item("Elixir of the Mongoose", 5, 7)] #sell in is 10 and quality is 20
        gilded_rose = GildedRose(items)
    ...
    def test_normal_item_expired(self):
        items = [Item("+5 Dexterity Vest", 10, 20)] #sell in is 10 and quality is 20
        gilded_rose = GildedRose(items)
    ...
    def test_AgedBrie_normal(self):
        items = [Item("Aged Brie", 2, 0)] #sell in is 10 and quality is 20
        gilded_rose = GildedRose(items)
    ...
    def test_Sulfuras_Ragnaros_normal(self):
        items = [Item("Sulfuras, Hand of Ragnaros", 0, 80), Item("Sulfuras, Hand of Ragnaros", -1, 80)] #sell in is 10 and quality is 20
        gilded_rose = GildedRose(items)
    ...
    def test_Concert_ticket_normal(self):
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 15, 20), Item("Backstage passes to a TAFKAL80ETC concert", 10, 49), Item("Backstage passes to a TAFKAL80ETC concert", 5, 49)] #sell in is 10 and quality is 20
        gilded_rose = GildedRose(items)
    ...
    def test_Conjured_Mana_Cake(self):
        items = [Item("Conjured Mana Cake", 3, 6)] #sell in is 10 and quality is 20
        gilded_rose = GildedRose(items)
